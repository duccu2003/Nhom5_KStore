...
KSTORE is an online platform specializing in buying and selling K-pop albums. This project aims to connect those who love Korean music with unique and rare products from all over the world.
...
- Give sellers a wider reach to potential customers.

## Requirements

- A computer running on Windows (as ASP.NET and SQL Server primarily support Windows).
- Git and.NET Core SDK (version 3.1 or later) installed.
...
2. Run two SQL files to set up the database:
...
4. Start the application:
   ...
   npm start
   ```
*If not able to do so through these methods, you can manually download or contact our team.*

## Usage

After starting the application, you can access it at `http://localhost:<port>` (replace `<port>` with the port displayed in the console) to begin using KSTORE.

## Contact Us

If you have any questions or suggestions, feel free to contact us via one of the following channels:
