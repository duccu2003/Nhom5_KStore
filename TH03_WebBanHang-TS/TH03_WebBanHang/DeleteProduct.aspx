<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteProduct.aspx.cs" Inherits="TH03_WebBanHang.DeleteProduct" %>
...
<body>
    ...
    <form id="form1" runat="server" style="position:relative;">
                       <a class="dropdown-item" href="ManagerProduct.aspx" style="margin:20px;  z-index:99; font-size:25px; text-align:center; border-radius:50%; border:1px solid #242426; width:35px; height:35px; align-items:center; align-content:center; justify-content:center; justify-items:center; position:fixed; background:#FFF;"><i class="fa-solid fa-caret-left" style="margin-right: 5px; width: 35px;"></i></a>
    ...
    <asp:Image ID="imgSP" runat="server" Style=" width:300px; height:300px; margin: 1rem auto; border-radius:10px;"/>
           			<asp:Label ID="lbMaSPV" Visible="false" runat="server" Text=""></asp:Label></b></span>
	...
	<span>Tên Sản Phẩm: <asp:Label ID="lbName" runat="server"
        ...
        <asp:Button ID="btDel" runat="server" Text="XÓA SẢN PHẨM" OnClick="btDel_Click" CssClass="btn-del justify-content-center align-content-center" style="margin:auto;" />
