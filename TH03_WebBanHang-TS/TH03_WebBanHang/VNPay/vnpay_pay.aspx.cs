...
namespace VNPAY_CS_ASPX
{
    public partial class _Default : System.Web.UI.Page
    {
        ...
        protected void ddlPaymentVNPaySelect_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        protected void btnPay_Click(object sender, EventArgs e)
        {
            ...
            if (/*bankcode_Vnpayqr.Checked == true || */ddlPaymentVNPaySelect.SelectedValue == "appVNPAYQR")
            {
                vnpay.AddRequestData("vnp_BankCode", "VNPAYQR");
            }
            if (/*bankcode_Vnbank.Checked == true*/ ddlPaymentVNPaySelect.SelectedValue == "atnVNBank")
            {
                vnpay.AddRequestData("vnp_BankCode", "VNBANK");
            }
            if (/*bankcode_Intcard.Checked == true*/ ddlPaymentVNPaySelect.SelectedValue == "intVNPay")
            {
