...
<%--                     <h5 class="mb-3">Cách 1: Chuyển hướng sang VNPAY chọn phương thức thanh toán</h5>--%>
                    <style>
                        ...
                        <asp:DropDownList ID="ddlPaymentVNPaySelect" runat="server" OnSelectedIndexChanged="ddlPaymentVNPaySelect_SelectedIndexChanged" AutoPostBack="True" CssClass="drop-vnpay-select"  style="padding:10px">
                          
                                
                            <asp:ListItem ID="bankcode_Default" Text="Cổng thanh toán VNPAYQR" Value="postVNPAYQR" style="color:#000;"></asp:ListItem>
                            ...
                            <asp:ListItem ID="bankcode_Vnbank" Text="ATM-Tài khoản ngân hàng nội địa" Value="atnVNBank" style="color:#000;"></asp:ListItem>
                            <asp:ListItem ID="bankcode_Intcard" Text="Thanh toán qua thẻ quốc tế" Value="intVNPay" style="color:#000;"></asp:ListItem>
...
<%--                    <h5 class="mb-3">Cách 2: Tách phương thức thanh toán tại site của Merchant</h5>--%>
                   ...
                   <%-- <div class="custom-control custom-radio">
                    ...
                    <h4>Chọn ngôn ngữ thanh toán:</h4>
                     ...
                     <asp:Button ID="btnPay" runat="server" Text="Thực hiện thanh toán" CssClass="btn btn-default" OnClick="btnPay_Click" />
                </div>
