...
*/
    ...
    <div id="notification" class="notification">
        ...
        <%--<asp:Image ID="imgNotification" runat="server" CssClass="imgNotification"/>--%>
        <p class="lbNotification">Thêm thành công!</p>
      <%--  <asp:Label ID="lbNotification" runat="server" CssClass="lbNotification"></asp:Label>--%>
    </div>
    <%--<div id="notificationRating" class="notificationRating">
        <%--<asp:Image ID="imgNotification" runat="server" CssClass="imgNotification"/>--%>
        <%--<p class="lbNotification">Bài đánh giá của bạn đã được gửi!</p>
      <%--  <asp:Label ID="lbNotification" runat="server" CssClass="lbNotification"></asp:Label>--%>
    <%--</div>--%>
   <%-- <script>
        document.addEventListener("DOMContentLoaded", function () {
            const notificationRating = document.getElementById('notificationRating');
            notificationRating.style.display = 'flex';

            // Ẩn thông báo sau 2 giây
            setTimeout(function () {
                notificationRating.style.display = 'none';
            }, 2000);
        });
    </script>--%>
    <script>
                    ...
                    <style>       
                        *{
                        ...
                        .div-DG::-webkit-scrollbar-track {
                                  ...
                                  border-radius: 10px;                             background:#00000040;
                        ...
                        @media only screen and (max-width: 768px) {
                            ...
                            #DGshow{
    max-height:100vh;  min-height:0;  padding:30px 15px  0px 15px;
    min-height:0vh;
}
                            #divVer{
...
<%--                                    <h3 style="width:max-content; text-align:center; ffamily:Roboto" class="text-center justify-content-center align-content-center"> Không có sản phẩm có liên quan.</h3>--%>
                         ...
                         <ItemTemplate>
                            ...
                            <%--<div class="card h-100">--%><a class="fade-in btn btn-outline-dark mt-auto btn-mua card h-100" href="item.aspx?sp=<%#:Item.MaSP%>">
                                     ...
                                     <img  title="<%#:Item.TenSP%>" loading="lazy" style="padding: 20px; height: max-content;" class="card-img-top img-with-hover" src="<%#:Item.DuongDan%>" alt="..." /><style>
                                         .img-with-hover {
 ...
 box-shadow:0 10px 50px #636363;
                    ...
                    <script>
                        ...
                        document.getElementById('closeRatingDiv').addEventListener('click', function () {
    ...
    height: max-content; ">    
         ...
         <span class="star" id="star5" ClientIDMode="Static" onclick="selectStar(5)" onmouseover="hoverStar(5)" onmouseout="removeHover()"><i class="fa-solid fa-star"></i></span>
                        ...
                        <div class="d-flex" style="/*width:80%; max-width:100%;*/ gap:10px; margin-top:1rem;">
...
<asp:TextBox ID="txtComment" placeholder="Mời bạn chia sẻ thêm cảm nhận..." spellcheck="false" type="text" runat="server" TextMode="MultiLine" Rows="4" Columns="50"  Visible="false" CssClass="fa-comment comment-item" style=" width:100%; padding:10px; "></asp:TextBox>
                                                    ...
                                                    <%--<asp:FileUpload ID="fileUploadImages" runat="server" AllowMultiple="true" style="width:5rem;"/>
                        <asp:FileUpload ID="fileUploadVideo" runat="server" style="width:5rem;"/>--%>
                        ...
                        <div class="d-grid">
                        <asp:FileUpload ID="fileUploadImages" runat="server" AllowMultiple="true" CssClass="custom-file-upload" />
                        <label for="fileUploadImages" class="custom-file-label"><i class="fa-solid fa-camera"></i></label>

                        <asp:FileUpload ID="fileUploadVideo" runat="server" CssClass="custom-file-upload"  />
                        <label for="fileUploadVideo" class="custom-file-label" style="margin-top:0.5rem;"><i class="fa-solid fa-video"></i></label>
                            </div>--%>
   ...
   <div class="cmtProfile-Non-Login"  style="margin:1rem auto; gap:1rem; justify-content:center; align-content:center; text-align:center;">
                            ...
                            <div class="d-grid">
<%--                            <asp:Label ID="lbHoTen" runat="server" Text="Họ tên: " Visible="false" CssClass="lb-add-pr-cmt"></asp:Label>--%>
                            <asp:TextBox ID="txtHoTen" placeholder="Họ Tên (bắt buộc)" type="text" runat="server" Visible="false" style="color:#000;border-radius:10px; border:1px solid #000; width:12rem; padding:5px;"></asp:TextBox></div>
                                                       <div class="d-grid"> 
<%--                                                           <asp:Label ID="lbSoDT" runat="server" Text="Số điện thoại: " Visible="false" CssClass="lb-add-pr-cmt"></asp:Label>--%>
                            ...
                            <asp:TextBox ID="txtDienThoai" placeholder="Số điện thoại (bắt buộc)"  runat="server"  Visible="false" style="color:#000; border-radius:10px;  border:1px solid #000;  width:12rem; padding:5px;"></asp:TextBox></div>
                                                   <div class="d-grid"> 
<%--                                                       <asp:Label ID="lbEmail" runat="server" Text="Email: " Visible="false" CssClass="lb-add-pr-cmt"></asp:Label>--%>
