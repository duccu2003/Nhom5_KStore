...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    width: 60px;
     ...
     width:100%;
                         ...
                         @media only screen and (max-width:768px){
                            ...
                            .divListItemFlex .col-sm-3{
                                width:100%;

                            }
                            .divListItemFlex .nav-item-inItem{
                                width:max-content;
                            }
                            .item-in-list-sp{
                                height:450px;
        ...
        <div id="divDetailProduct" class="row gx-4 gx-lg-5 align-items-center" style=" border-radius:10px;">                        
            <div class="widget-container">
                ...
                <div class="widget-item">
                    <a onclick="executeBothFunctions();" href="#" class="widget-link" style="z-index:99999;"  title="Nhắn tin với KStore" >
            ...
            <asp:FormView ID="productDetail" runat="server" ItemType="TH03_WebBanHang.Models.SanPham" SelectMethod="GetDetails" RenderOuterTable="false" OnPageIndexChanging="productDetail_PageIndexChanging">
                <ItemTemplate>
                    <div class="col-md-6 py-3" id="slSP">
                        <a id="imgProduct" data-options="zoomPosition: inner" href="<%#:Item.DuongDan%>" style="border-radius:20px;" class="card-img-top mb-5 mb-md-0 zoom-hover MagicZoom product-detail-Img">
                            <img title="<%#:Item.TenSP%>" loading="lazy" style="" class="product-detail-Img card-img-top" src="<%#:Item.DuongDan%>" alt="..." />
                        </a>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="d-grid" id="divButtonMuaGioDG" style="gap: 0.85rem;">                               
                            ...
                            <a title="Xem nội dung bên trong của sản phẩm" id="btnViewMore" class="btn btn-outline-dark flex-shrink-0 btn-item btn-at-sp-hover btn-bold" style="height:45px; cursor:pointer; justify-content:center; align-content:center; align-items:center; justify-items:center; text-align:center;" href="#" onclick="toggleAdditionalContent(); return false;">XEM NỘI DUNG BÊN TRONG SẢN PHẨM</a>
                        ...
                        <div loading="lazy" id="divVer" class="div-Ver d-flex" style="gap:0.5rem; height:160px !important;   flex-wrap:wrap;  height:max-content; border-top:1px  dashed #fff; padding-top:2rem;">
                            ...
                            <ItemTemplate>
                                ...
                                <p id="pTenVer" loading="lazy" style="flex-wrap:wrap;   border-radius:10px; padding:2.5px 0  -1rem 0;"><%#:Item.TenVer %></p></a>
                            </ItemTemplate>
                        </asp:ListView>
            ...
            <div class="div-bottom-product-content py-1" style="margin:0.5rem; gap:20px; margin-bottom:2rem; flex-wrap:wrap;">                                                                                                                              
                    ...
                    <ItemTemplate>
                            <div class="d-grid" style="width:100%;">
                                <div id="listImageDetailt" class="div-bottom-product-content" style=" gap:20px; flex-wrap:wrap;">
                                  ...
                                  <%# IfNotNullOrEmpty(Item.DuongDan1, $"<a data-zoom-id='imgProduct' href='" + Item.DuongDan1 + "' data-image='" + Item.DuongDan1 + "'><img src='" + Item.DuongDan1 + "' class='product-image' /></a>") %>
                                  <%# IfNotNullOrEmpty(Item.DuongDan2, $"<a data-zoom-id='imgProduct' href='" + Item.DuongDan2 + "' data-image='" + Item.DuongDan2 + "'><img src='" + Item.DuongDan2 + "' class='product-image' /></a>") %>
                                  <%# IfNotNullOrEmpty(Item.DuongDan3, $"<a data-zoom-id='imgProduct' href='" + Item.DuongDan3 + "' data-image='" + Item.DuongDan3 + "'><img src='" + Item.DuongDan3 + "' class='product-image' /></a>") %>
                                  <%# IfNotNullOrEmpty(Item.DuongDan4, $"<a data-zoom-id='imgProduct' href='" + Item.DuongDan4 + "' data-image='" + Item.DuongDan4 + "'><img src='" + Item.DuongDan4 + "' class='product-image' /></a>") %>
  ...
  <div class="collapse navbar-collapse divListItemGrid" id="navbarNav" style="width:252px; margin-top:0; padding:10px 0; background:linear-gradient(to right, #522A77, #2a2e77); height:max-content; border-radius:6px;">
    ...
    <ItemTemplate>
        ...
        <li class="nav-item-inItem nav-item nav-loai-menu">
    <a class="nav-link ds-loai-sp" href="#" data-ls="<%# Eval("MaLoai") %>"><%# Eval("TenLoai") %></a>
                     ...
                     <div id="divListItems" class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-3 justify-content-left" style="">
                         <asp:ListView ID="ListView1" runat="server" ItemType="TH03_WebBanHang.Models.SanPham" SelectMethod="GetPhones">

                             <EmptyDataTemplate>
                                
                                 <div class="fade-in" style="padding:10px 20px; background:linear-gradient(to right, #522A77, #2a2e77); height:max-content; border-radius:6px; width:100%; font-family: 'Baloo 2', sans-serif; text-align:center; justify-content:center; align-content:flex-start; justify-items:center; align-items:center;">
                         ...
                         <ItemTemplate>
                             ...
                             <div class="col mb-5 divItem-In-ListItems" style="">
                            <%--<div class="card h-100">--%>
                                 <a class="fade-in btn btn-outline-dark mt-auto btn-mua card item-in-list-sp" style="" href="item.aspx?sp=<%#:Item.MaSP%>">
                                     <!-- Product image-->
...
<asp:TextBox ID="txtEmail" placeholder="Địa chỉ Email (bắt buộc)" type="email" runat="server"  Visible="false" style="color:#000; border-radius:10px;  border:1px solid #000;  width:12rem; padding:5px;"></asp:TextBox></div>
    ...
    <script src="Scripts/js/magiczoomplus.js"></script>
    ...
    <script>
        ...
        function executeBothFunctions() {
            ...
            function changeMainImage(src) {
                ...
                document.querySelector('.card-img-top').href = src;
