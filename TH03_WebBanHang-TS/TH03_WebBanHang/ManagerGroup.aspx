<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerGroup.aspx.cs" Inherits="TH03_WebBanHang.ManagerGroup" %>
...
#searchinputA {
    ...
    background: #FFFF;
        ...
        <a class="btn btn-default btn-color mx-2" style="padding:5px;background:#FFF; border:1px solid #242426; color:#000; width:8rem;  height:40px !important; padding:10px; border-radius:5px; justify-content:left" href="AddGroup.aspx">Thêm nhóm/nghệ sĩ</a>
<%--        <a class="btn btn-default btn-color mx-2" style="padding:5px;background:#FFF; border:1px solid #242426;  color:#000; width:8rem;  height:40px !important;padding:10px; border-radius:5px; justify-content:left" href="UpdatePob.aspx">Thêm Pob</a>--%>
        ...
        <asp:ListView ID="ListView1" runat="server" ItemType="TH03_WebBanHang.Models.Nhom" SelectMethod="GetDeparments" OnSelectedIndexChanged="ListView1_SelectedIndexChanged" class="text-center ListView1">
        <EmptyDataTemplate>
     ...
     <tr style="border:none">
        ...
        <ItemTemplate>
            ...
            <a class="a-hadItems" href="item.aspx?gp=<%#:Item.MaNhom%>"><%#:Item.MaNhom%></a>
        </td>
            <td class="justify-content-center align-content-center">
                <a class="a-hadItems" href="item.aspx?gp=<%#:Item.MaNhom%>"><%#:Item.TenNhom%></a>
            </td>
            <td class="justify-content-center align-content-center" style="padding:0 10px; width:max-content; height:max-content;">
                <a class="a-hadItems" href="item.aspx?gp=<%#:Item.MaNhom%>">
                    <img src='<%#:Item.DuongDan%>' alt='...' style='border:1px solid #242426; border-radius:20px; height: 6rem; width:6rem; object-fit:cover;' />
                </a>
            </td>
            <td class="justify-content-center align-content-center">
                <a class="a-hadItems" href="item.aspx?gp=<%#:Item.MaNhom%>"><img alt='...' style='border:1px solid #242426; border-radius:10px; height: 6rem; object-fit:cover;' src="<%#:Item.AnhNhom%>"/></a>
            </td>
            <td class="justify-content-center align-content-center"><%#:Item.SanPhams.Count().ToString()%></td>
           ...
           <%-- <td class="justify-content-center align-content-center d-grid" style="display:grid !important; height:100% !important; row-gap:1rem;">
                    ...
                    <a class="btn btn-default btn-color btn-w" href='UpdateProduct.aspx?Deptid=<%#:Item.MaNhom%>'>Chỉnh sửa</a>
                    <a class="btn btn-default btn-color btn-w" href='DeleteProduct.aspx?Deptid=<%#:Item.MaNhom%>'>Xóa</a>
