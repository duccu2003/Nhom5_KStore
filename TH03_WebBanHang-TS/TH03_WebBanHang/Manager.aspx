                     ...
                     <div class="container-fuild px-5 px-lg-5" style="margin:24px auto;">
                         <div class="row" style="margin:24px auto;  width:100%;">
                            <div class="col-lg-6 col-sm-6" style="text-align: center; padding:0; padding-right:10px;">
                                <div class="card d-flex text-left justify-content-center align-content-center text-white bg-primary" style="gap:10px; text-shadow:0 0 1px #000; height:265px; border:3px solid white;  padding:10px; border-radius:6px; background:#FFFFFF;">
                                    
                                        <h2>Doanh thu: <asp:Label ID="lbTotalAll" runat="server" CssClass="LabelTotalRevenue extra-bold count" Text="" Style="font-weight: bold;"></asp:Label></h2>
                                        <p style="border-radius:6px; background:#000; width:max-content; padding:0 10px; margin:0 auto;"><strong id="dauphantram" class="textphantram" runat="server"></strong><strong id="phantram" class="textphantram" runat="server"></strong><strong class="textphantram">% </strong><strong class="textphantram" style="color:#FFF;">so với tháng trước</strong></p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6 d-grid" style="text-align: center; row-gap:24px; padding:0; padding-left:10px; ">
                                <div class="card d-flex text-left justify-content-center align-content-center text-white bg-success" style="text-shadow:0 0 1px #000; border:3px solid white;  height:120px; padding:10px; border-radius:6px; background:#FFFFFF;">
                                ...
                                <div class="card d-flex text-left justify-content-center align-content-center text-white bg-warning bg-dark" style="text-shadow:0 0 1px #000; border:3px solid white; height:120px; padding:10px; border-radius:6px; background:#FFFFFF;">
                            ...
                            <div class="row" style="margin:24px auto;  width:100%;">
                                 <div class="col-lg-4 col-sm-4" style="text-align: center; padding:0 10px 0 0;">
                                   <div class="card d-grid text-left justify-content-center align-content-center text-dark row3-items" style="width:100%; padding:10px; border-radius:6px;">
                                               <div class="imgdiv">
