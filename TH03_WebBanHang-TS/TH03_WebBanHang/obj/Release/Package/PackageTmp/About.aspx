...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
 <%--   <h2><%: Title %>.</h2>--%>
    <%--<h2><img src="Content/logo/logo.png" id="img-logo"/><style>#img-logo{width:180px;}</style></h2>--%>
     ...
     <h1 class="fw-bolder mb-4 tenSP-ls-h3"><p class="tenSP-ls-p">Thành Viên Nhóm</p></h1>
        ...
        <div class="row element show">
            ...
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
              ...
              <div class="single_advisor_details_info">
                <h6>Nguyễn Hoàng Đức</h6>
                <p class="designation">2105CT0098</p>
              </div>
            </div>
          </div>
          <!-- Single Advisor-->
          <div class="col-12 col-sm-6 col-lg-3 element show">
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
              ...
              <!-- Team Details-->
              <div class="single_advisor_details_info">
                <h6>Trần Phương Uyên</h6>
                <p class="designation">2105CT0027</p>
              </div>
            </div>
          </div>
          <!-- Single Advisor-->
          <div class="col-12 col-sm-6 col-lg-3 element show">
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
              ...
              <div class="single_advisor_details_info">
                <h6>Võ Thành Phát</h6>
                <p class="designation">2105CT0060</p>
              </div>
            </div>
          </div>
          <!-- Single Advisor-->
          <div class="col-12 col-sm-6 col-lg-3 element show">
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
              <!-- Team Thumb-->
              <div class="advisor_thumb"><img src="https://i.pinimg.com/736x/a2/c7/57/a2c7574a1891d64d53bc304f2aa5024b.jpg" alt="">
                <!-- Social Info-->
                <div class="social-info"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-linkedin"></i></a></div>
              </div>
              <!-- Team Details-->
              <div class="single_advisor_details_info">
                <h6>Nguyễn Thế Hùng</h6>
                <p class="designation">2105CT0076</p>
              </div>
            </div>
          </div>
          <!-- Single Advisor-->
          <div class="col-12 col-sm-6 col-lg-3 element show">
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
              <!-- Team Thumb-->
              <div class="advisor_thumb"><img src="https://img.freepik.com/premium-photo/cartoon-fat-man-running-cloudy-sky_662214-62624.jpg" alt="">
                <!-- Social Info-->
                <div class="social-info"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-linkedin"></i></a></div>
              </div>
              <!-- Team Details-->
              <div class="single_advisor_details_info">
                <h6>Nguyễn Văn Phong</h6>
                <p class="designation">2105CT0077</p>
              </div>
            </div>
          </div>
            ...
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
              <!-- Team Thumb-->
              <div class="advisor_thumb"><img src="https://i.pinimg.com/736x/37/3e/92/373e920c92c68852a0a872cbfba6036d.jpg" alt="">
                <!-- Social Info-->
                <div class="social-info"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-linkedin"></i></a></div>
              </div>
              <!-- Team Details-->
              <div class="single_advisor_details_info">
                <h6>Trần Nhất Anh</h6>
                <p class="designation">2105CT0099</p>
              </div>
            </div>
          </div>
        </div>
